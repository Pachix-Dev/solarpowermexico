                ...
                <Row className='mt-5 pt-5'>
                  ...
                  <Col md className='pt-5 mt-auto'>
                    <svg id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1501.17 1662.94' fill='none' stroke='white' strokeMiterlimit={10} strokeWidth={14} width={150}>
                      <path class='cls-1' d='m203.31,1378.11l1033.86-552.09c2.48-1.32,1.73-5.06-1.07-5.32l-433.32-41.27c-2.26-.22-3.36-2.87-1.92-4.63l388.11-469.82c2.11-2.56-1.13-6.04-3.83-4.11L340.17,904.8c-2.19,1.57-1.17,5.02,1.53,5.14l297.38,12.71c2.46.11,3.62,3.08,1.89,4.82l-441.01,446.14c-2.28,2.31.48,6.02,3.35,4.49Z' />
                      <g>
                        <path class='cls-1' d='m1188.25,300.74c330.64,247.06,402.98,716.46,169.33,1045.33-239.46,337.06-762.98,411.96-1076.84,158.99-1.84-1.48-1.15-4.43,1.15-4.96l155.69-36.03' />
                        <line class='cls-1' x1='279.69' y1='1501.4' x2='315.69' y2='1661.4' />
                      </g>
                      <g>
                        <path class='cls-1' d='m199.97,1378.47C-24.47,1127.73-56.37,756.83,121.3,473.13,294.25,196.98,686.78,51.42,961.71,156.41c2.73,1.04,5.07-2.2,3.21-4.45L842.64,4.47' />
                        <line class='cls-1' x1='963.63' y1='154.96' x2='814.78' y2='280.08' />
                      </g>
                    </svg>
