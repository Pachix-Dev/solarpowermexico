  ...
  return (
    <>
      ...
      <section className='mt-5 home-bg-solarvideo'>
        ...
        <div className='home-text-video'>
          <div className='p-3'>
            ...
            <p className='w-75'>
              <strong>SOLAR + STORAGE MEXICO</strong> {t('home.become_sponsor_desc')}
            </p>
      ...
      <section className='mt-5'>
        <Container fluid>
          <p className='fw-bold fs-5 text-secondary text-center'>{t('home.organized_by')}:</p>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>{t('home.strategic_partners')}:</p>
          <Row className='text-center'>
            <Col md={3} className='mx-auto my-auto'>
