                                ...
                                return (
                                    <Row className="align-items-start justify-content-center program-date-item text-white">
                                        ...
                                        <Col lg={8} xs={12} md={9}>
                                            ...
                                            <a href="https://www.ibesalliance.org/events/navigating-the-mexican-energy-storage-landscape-unlocking-opportunities-and-monetization-strategies" target='_blank' className='fs-4 fw-semibold link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover' >
