              ...
              <Link to='/energy-night' className='text-decoration-none'>
                <Row>
                  ...
                  <Col md className='mt-auto'>
                    ...
                    <p className='pt-2 fw-bold text-light fs-1 lh-1'>ENERGY<br /><span className='fw-light fs-3'>NIGHT</span></p>
                    <p className='m-0 energy-description' dangerouslySetInnerHTML={{ __html: t('home.energy_night_description') }} />
                  </Col>
                  <Col md className='mt-auto'>
