    ...
    <div className='program-solar'>
      {/* <Container className='py-5'>
        <Row className='gap-5 text-center'>
          <Col className=''> <p className='text-uppercase'> Programa Académico </p> <Button variant="outline-primary">SABER MÁS</Button>{' '}</Col>
          <Col className=''> 
              <p className='text-uppercase'>Enlightenment Area</p>
