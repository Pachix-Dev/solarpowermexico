  ...
  return (
    <>
      <Container>
        ...
        <section>
          <p className='fw-bold fs-2 text-center home-text-color'>Galeria SSM 2023</p>
          <Gallery />
        </section>
      </Container>
      ...
      <section className='mt-5 home-bg-solarvideo'>
        <video
          width='100%'
          height='auto'
          muted
          ...
          autoPlay
          playsInline
          poster='/solarpowerBG.webp'
          src='/solarpowerBG.webm'
        />
        <div className='home-text-video'>
          <div className='p-3'>
            ...
            <p className='w-75'>
              <strong>SOLAR + STORAGE MEXICO</strong> cuenta con el respaldo de los mayores eventos de energía solar del mundo. Si usted está buscando iniciar nuevas oportunidades de negocio o hacer crecer su negocio en América Latina, un patrocinio le puede aumentar impresiones positivas frente a un público objetivo pagado. Conozca más sobre las oportunidades de mercado.
            </p>
            <span>LEER MÁS</span>
          </div>
        </div>
      ...
      <section className='mt-5'>
        <Container fluid>
          <p className='fw-bold fs-5 text-secondary text-center'>Organizado por:</p>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Powered by:</p>
          <Row className='text-center'>
            <Col md={3} className='mx-auto my-auto'>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Nuestros Aliados Estratégicos:</p>
          <Row className='text-center'>
            <Col md={3} className='mx-auto my-auto'>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Broadcasting Media Partner</p>
          <Row className='text-center'>
            <Col md={3} className='mt-3 mx-auto my-auto'>
              <a href='https://heraldodemexico.com.mx/' target='_blank' rel='noreferrer'>
                <img src='/El_Heraldo_de_Mexico.webp' width={200} loading='lazy' alt='El_Heraldo_de_Mexico' />
              </a>
            </Col>
          </Row>
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Platinum Media Partner</p>
          <Row className='text-center'>
            <Col md={3} className='mx-auto my-auto'>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Gold Media Partners</p>
          <Row className='text-center'>
            <Col md={3} className='pt-3 mx-auto my-auto'>
          ...
          <p className='mt-5 fw-bold fs-5 text-secondary text-center'>Silver Media Partners</p>
          <Row className='text-center'>
            <Col md={3} className='pt-3 mx-auto my-auto'>
