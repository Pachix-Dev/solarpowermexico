          ...
          <div className='slider-solar slider-bg-energynight'>
            <Container fluid>
              <Link to='/energy-night' className='text-decoration-none'>
                <Row>
                  <Col md className='mt-auto d-none d-lg-block'>
                    <p
                      className='text-light fs-1'
                      dangerouslySetInnerHTML={{
                        __html: t('home.energy_night'),
                      }}
                    />
                    <div className='d-flex justify-content-center'>
                      <ul
                        dangerouslySetInnerHTML={{
                          __html: t('home.energy_night_tags'),
                        }}
                      />
                    </div>
                  </Col>
                  <Col md className='mt-auto'>
                    ...
                    <p className='pt-2 fw-bold text-light fs-1 lh-1'>
                      ENERGY
                      <br />
                      <span className='fw-light fs-3'>NIGHT</span>
                    </p>
                    <p
                      className='m-0 energy-description'
                      dangerouslySetInnerHTML={{
                        __html: t('home.energy_night_description'),
                      }}
                    />
                  </Col>
                  <Col md className='mt-auto'>
                    <div className='d-flex justify-content-center'>
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: t('home.energy_night_date'),
                        }}
                      />
                    </div>
                  </Col>
